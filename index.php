...
function timeremaining(time){
	...
	document.getElementById('timer').innerHTML = "<font size=3>Come back in</font><br><font size=4><b>" + minutes + " minutes, " + seconds + " seconds</b></font><br><font size=3>if you're still bored</font>"; 
	checkcookienotimer();
	}, 1000);
...
totalagain();
  ...
  <form name="eqip">
  <button type="button" onclick="countdown()" class="btn" id="bored"><font size=6>I'M BORED!</font></button>
  </form><br><br>
